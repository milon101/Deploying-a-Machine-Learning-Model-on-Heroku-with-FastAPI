#!/usr/bin/env python
"""
This script splits the given dataframe in test and remainder
"""
import argparse
import logging
...
def go(args):
    ...
    logger.info(f"Fething artifact {args.input}")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Split the dataset in train and test sets")
